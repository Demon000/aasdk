...
class CryptorMock : public ICryptor {
 public:
  ...
  MOCK_METHOD2(encrypt, size_t(common::Data& output,
                               const common::DataConstBuffer& buffer));
  MOCK_METHOD2(decrypt, size_t(common::Data& output,
                               const common::DataConstBuffer& buffer));
  MOCK_METHOD0(readHandshakeBuffer, common::Data());
  MOCK_METHOD1(writeHandshakeBuffer,
               void(const common::DataConstBuffer& buffer));
