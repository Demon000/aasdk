...
void ControlServiceChannel::sendVersionRequest(SendPromise::Pointer promise) {
  ...
  message->insertPayload(
      messenger::MessageId(proto::ids::ControlMessage::VERSION_REQUEST)
          .getData());

  common::Data versionBuffer(4, 0);
  reinterpret_cast<uint16_t&>(versionBuffer[0]) =
      boost::endian::native_to_big(AASDK_MAJOR);
  reinterpret_cast<uint16_t&>(versionBuffer[2]) =
      boost::endian::native_to_big(AASDK_MINOR);
  message->insertPayload(versionBuffer);

  this->send(std::move(message), std::move(promise));
}

void ControlServiceChannel::sendHandshake(common::Data handshakeBuffer,
                                          SendPromise::Pointer promise) {
  auto message(std::make_shared<messenger::Message>(
      channelId_, messenger::EncryptionType::PLAIN,
      messenger::MessageType::SPECIFIC));
  message->insertPayload(
      messenger::MessageId(proto::ids::ControlMessage::SSL_HANDSHAKE)
          .getData());
...
void ControlServiceChannel::sendAuthComplete(
  ...
  auto message(std::make_shared<messenger::Message>(
      ...
      messenger::MessageType::SPECIFIC));
  message->insertPayload(
      messenger::MessageId(proto::ids::ControlMessage::AUTH_COMPLETE)
          .getData());
...
void ControlServiceChannel::sendServiceDiscoveryResponse(
  ...
  message->insertPayload(
      messenger::MessageId(
          proto::ids::ControlMessage::SERVICE_DISCOVERY_RESPONSE)
          .getData());
  message->insertPayload(response);
...
void ControlServiceChannel::sendAudioFocusResponse(
  ...
  auto message(std::make_shared<messenger::Message>(
      ...
      messenger::MessageType::SPECIFIC));
  message->insertPayload(
      messenger::MessageId(proto::ids::ControlMessage::AUDIO_FOCUS_RESPONSE)
          .getData());
  message->insertPayload(response);
...
void ControlServiceChannel::sendShutdownRequest(
  ...
  auto message(std::make_shared<messenger::Message>(
      ...
      messenger::MessageType::SPECIFIC));
  message->insertPayload(
      messenger::MessageId(proto::ids::ControlMessage::SHUTDOWN_REQUEST)
          .getData());
...
void ControlServiceChannel::sendShutdownResponse(
  ...
  auto message(std::make_shared<messenger::Message>(
      ...
      messenger::MessageType::SPECIFIC));
  message->insertPayload(
      messenger::MessageId(proto::ids::ControlMessage::SHUTDOWN_RESPONSE)
          .getData());
  message->insertPayload(response);
...
void ControlServiceChannel::sendNavigationFocusResponse(
  ...
  message->insertPayload(
      messenger::MessageId(
          proto::ids::ControlMessage::NAVIGATION_FOCUS_RESPONSE)
          .getData());
  message->insertPayload(response);
...
void ControlServiceChannel::sendPingResponse(
  ...
  auto message(std::make_shared<messenger::Message>(
      ...
      messenger::MessageType::SPECIFIC));
  message->insertPayload(
      messenger::MessageId(proto::ids::ControlMessage::PING_RESPONSE)
          .getData());
  message->insertPayload(request);
...
void ControlServiceChannel::sendPingRequest(
  ...
  auto message(std::make_shared<messenger::Message>(
      ...
      messenger::MessageType::SPECIFIC));
  message->insertPayload(
      messenger::MessageId(proto::ids::ControlMessage::PING_REQUEST).getData());
  message->insertPayload(request);

  this->send(std::move(message), std::move(promise));
}

void ControlServiceChannel::receive(
    IControlServiceChannelEventHandler::Pointer eventHandler) {
  auto receivePromise = messenger::ReceivePromise::defer(strand_);
  receivePromise->then(
      std::bind(&ControlServiceChannel::messageHandler,
                this->shared_from_this(), std::placeholders::_1, eventHandler),
      std::bind(&IControlServiceChannelEventHandler::onChannelError,
                eventHandler, std::placeholders::_1));

  messenger_->enqueueReceive(channelId_, std::move(receivePromise));
}

void ControlServiceChannel::messageHandler(
  ...
  switch (messageId.getId()) {
    ...
    case proto::ids::ControlMessage::VOICE_SESSION_REQUEST:
      ...
      break;
    default:
      AASDK_LOG(error) << "[ControlServiceChannel] message not handled: "
                       << messageId.getId();
...
void ControlServiceChannel::handleVersionResponse(
    const common::DataConstBuffer& payload,
    IControlServiceChannelEventHandler::Pointer eventHandler) {
  const size_t elements = payload.size / sizeof(uint16_t);
  const uint16_t* versionResponse =
      reinterpret_cast<const uint16_t*>(payload.cdata);

  uint16_t majorCode =
      elements > 0 ? boost::endian::big_to_native(versionResponse[0]) : 0;
  uint16_t minorCode =
      elements > 1 ? boost::endian::big_to_native(versionResponse[1]) : 0;
  proto::enums::VersionResponseStatus::Enum status =
      elements > 2 ? static_cast<proto::enums::VersionResponseStatus::Enum>(
                         versionResponse[2])
...
void ControlServiceChannel::handleServiceDiscoveryRequest(
    const common::DataConstBuffer& payload,
    IControlServiceChannelEventHandler::Pointer eventHandler) {
...
void ControlServiceChannel::handleAudioFocusRequest(
    const common::DataConstBuffer& payload,
    IControlServiceChannelEventHandler::Pointer eventHandler) {
...
void ControlServiceChannel::handleVoiceSessionRequest(
    const common::DataConstBuffer& payload,
    IControlServiceChannelEventHandler::Pointer eventHandler) {
...
void ControlServiceChannel::handleShutdownRequest(
    const common::DataConstBuffer& payload,
    IControlServiceChannelEventHandler::Pointer eventHandler) {
...
void ControlServiceChannel::handleShutdownResponse(
    const common::DataConstBuffer& payload,
    IControlServiceChannelEventHandler::Pointer eventHandler) {
...
void ControlServiceChannel::handleNavigationFocusRequest(
    const common::DataConstBuffer& payload,
    IControlServiceChannelEventHandler::Pointer eventHandler) {
...
void ControlServiceChannel::handlePingRequest(
    const common::DataConstBuffer& payload,
    IControlServiceChannelEventHandler::Pointer eventHandler) {
...
void ControlServiceChannel::handlePingResponse(
    const common::DataConstBuffer& payload,
    IControlServiceChannelEventHandler::Pointer eventHandler) {
