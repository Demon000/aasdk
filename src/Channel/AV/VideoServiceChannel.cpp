...
void VideoServiceChannel::receive(
    IVideoServiceChannelEventHandler::Pointer eventHandler) {
  auto receivePromise = messenger::ReceivePromise::defer(strand_);
  receivePromise->then(
      std::bind(&VideoServiceChannel::messageHandler, this->shared_from_this(),
...
void VideoServiceChannel::sendVideoFocusIndication(
  ...
  auto message(std::make_shared<messenger::Message>(
      ...
      messenger::MessageType::SPECIFIC));
  message->insertPayload(
      messenger::MessageId(proto::ids::AVChannelMessage::VIDEO_FOCUS_INDICATION)
          .getData());
...
void VideoServiceChannel::messageHandler(
  ...
  switch (messageId.getId()) {
    ...
    case proto::ids::AVChannelMessage::VIDEO_FOCUS_REQUEST:
      ...
      break;
    default:
      AASDK_LOG(error) << "[VideoServiceChannel] message not handled: "
                       << messageId.getId();
...
void VideoServiceChannel::handleAVChannelSetupRequest(
...
void VideoServiceChannel::handleStartIndication(
    const common::DataConstBuffer& payload,
    IVideoServiceChannelEventHandler::Pointer eventHandler) {
...
void VideoServiceChannel::handleStopIndication(
    const common::DataConstBuffer& payload,
    IVideoServiceChannelEventHandler::Pointer eventHandler) {
...
void VideoServiceChannel::handleChannelOpenRequest(
    const common::DataConstBuffer& payload,
    IVideoServiceChannelEventHandler::Pointer eventHandler) {
...
void VideoServiceChannel::handleVideoFocusRequest(
    const common::DataConstBuffer& payload,
    IVideoServiceChannelEventHandler::Pointer eventHandler) {
...
void VideoServiceChannel::handleAVMediaWithTimestampIndication(
    const common::DataConstBuffer& payload,
    IVideoServiceChannelEventHandler::Pointer eventHandler) {
