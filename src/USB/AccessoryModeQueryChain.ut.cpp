...
class AccessoryModeQueryChainUnitTest {
 protected:
  AccessoryModeQueryChainUnitTest()
    ...
    promise_->then(
        std::bind(&AccessoryModeQueryChainPromiseHandlerMock::onResolve,
                  &promiseHandlerMock_, std::placeholders::_1),
        std::bind(&AccessoryModeQueryChainPromiseHandlerMock::onReject,
                  &promiseHandlerMock_, std::placeholders::_1));
  }
...
BOOST_FIXTURE_TEST_CASE(AccessoryModeQueryChain_QueryAOAPDevice,
                        AccessoryModeQueryChainUnitTest) {
  AccessoryModeQueryChain::Pointer queryChain(
      std::make_shared<AccessoryModeQueryChain>(usbWrapperMock_, ioService_,
                                                queryFactoryMock_));
  ...
  EXPECT_CALL(queryFactoryMock_,
              createQuery(AccessoryModeQueryType::PROTOCOL_VERSION, _))
  ...
  EXPECT_CALL(
      queryFactoryMock_,
      createQuery(AccessoryModeQueryType::SEND_MANUFACTURER, usbEndpoint))
  ...
  queryPromise->resolve(usbEndpoint);
  EXPECT_CALL(queryFactoryMock_,
              createQuery(AccessoryModeQueryType::SEND_MODEL, usbEndpoint))
      .WillOnce(Return(queryMock_));
  ioService_.run();
  ioService_.reset();
  ...
  EXPECT_CALL(
      queryFactoryMock_,
      createQuery(AccessoryModeQueryType::SEND_DESCRIPTION, usbEndpoint))
      .WillOnce(Return(queryMock_));
  ioService_.run();
  ioService_.reset();
  ...
  queryPromise->resolve(usbEndpoint);
  EXPECT_CALL(queryFactoryMock_,
              createQuery(AccessoryModeQueryType::SEND_VERSION, usbEndpoint))
      .WillOnce(Return(queryMock_));
  ioService_.run();
  ioService_.reset();
  ...
  queryPromise->resolve(usbEndpoint);
  EXPECT_CALL(queryFactoryMock_,
              createQuery(AccessoryModeQueryType::SEND_URI, usbEndpoint))
      .WillOnce(Return(queryMock_));
  ioService_.run();
  ioService_.reset();
  ...
  queryPromise->resolve(usbEndpoint);
  EXPECT_CALL(queryFactoryMock_,
              createQuery(AccessoryModeQueryType::SEND_SERIAL, usbEndpoint))
      .WillOnce(Return(queryMock_));
  ioService_.run();
  ioService_.reset();
  ...
  queryPromise->resolve(usbEndpoint);
  EXPECT_CALL(queryFactoryMock_,
              createQuery(AccessoryModeQueryType::START, usbEndpoint))
      .WillOnce(Return(queryMock_));
  ioService_.run();
  ioService_.reset();
...
BOOST_FIXTURE_TEST_CASE(AccessoryModeQueryChain_ProtocolVersionQueryFailed,
                        AccessoryModeQueryChainUnitTest) {
  AccessoryModeQueryChain::Pointer queryChain(
      std::make_shared<AccessoryModeQueryChain>(usbWrapperMock_, ioService_,
                                                queryFactoryMock_));
...
BOOST_FIXTURE_TEST_CASE(AccessoryModeQueryChain_ManufacturerQueryFailed,
                        AccessoryModeQueryChainUnitTest) {
  AccessoryModeQueryChain::Pointer queryChain(
      std::make_shared<AccessoryModeQueryChain>(usbWrapperMock_, ioService_,
                                                queryFactoryMock_));
...
BOOST_FIXTURE_TEST_CASE(AccessoryModeQueryChain_ModelQueryFailed,
                        AccessoryModeQueryChainUnitTest) {
  AccessoryModeQueryChain::Pointer queryChain(
      std::make_shared<AccessoryModeQueryChain>(usbWrapperMock_, ioService_,
                                                queryFactoryMock_));
...
BOOST_FIXTURE_TEST_CASE(AccessoryModeQueryChain_DescriptionQueryFailed,
                        AccessoryModeQueryChainUnitTest) {
  AccessoryModeQueryChain::Pointer queryChain(
      std::make_shared<AccessoryModeQueryChain>(usbWrapperMock_, ioService_,
                                                queryFactoryMock_));
...
BOOST_FIXTURE_TEST_CASE(AccessoryModeQueryChain_VersionQueryFailed,
                        AccessoryModeQueryChainUnitTest) {
  AccessoryModeQueryChain::Pointer queryChain(
      std::make_shared<AccessoryModeQueryChain>(usbWrapperMock_, ioService_,
                                                queryFactoryMock_));
...
BOOST_FIXTURE_TEST_CASE(AccessoryModeQueryChain_URIQueryFailed,
                        AccessoryModeQueryChainUnitTest) {
  AccessoryModeQueryChain::Pointer queryChain(
      std::make_shared<AccessoryModeQueryChain>(usbWrapperMock_, ioService_,
                                                queryFactoryMock_));
...
BOOST_FIXTURE_TEST_CASE(AccessoryModeQueryChain_SerialQueryFailed,
                        AccessoryModeQueryChainUnitTest) {
  AccessoryModeQueryChain::Pointer queryChain(
      std::make_shared<AccessoryModeQueryChain>(usbWrapperMock_, ioService_,
                                                queryFactoryMock_));
...
BOOST_FIXTURE_TEST_CASE(AccessoryModeQueryChain_StartQueryFailed,
                        AccessoryModeQueryChainUnitTest) {
  AccessoryModeQueryChain::Pointer queryChain(
      std::make_shared<AccessoryModeQueryChain>(usbWrapperMock_, ioService_,
                                                queryFactoryMock_));
...
BOOST_FIXTURE_TEST_CASE(AccessoryModeQueryChain_Cancel,
                        AccessoryModeQueryChainUnitTest) {
  AccessoryModeQueryChain::Pointer queryChain(
      std::make_shared<AccessoryModeQueryChain>(usbWrapperMock_, ioService_,
                                                queryFactoryMock_));
...
BOOST_FIXTURE_TEST_CASE(AccessoryModeQueryChain_RejectWhenInProgress,
                        AccessoryModeQueryChainUnitTest) {
