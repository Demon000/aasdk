...
class USBHub : public IUSBHub,
               public std::enable_shared_from_this<USBHub>,
               boost::noncopyable {
 public:
 ...
 private:
  ...
  static int hotplugEventsHandler(libusb_context* usbContext,
                                  libusb_device* device,
                                  libusb_hotplug_event event, void* uerData);
