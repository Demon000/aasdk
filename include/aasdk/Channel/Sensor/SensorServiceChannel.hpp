...
class SensorServiceChannel
 ...
 public:
  ...
  void receive(
      ISensorServiceChannelEventHandler::Pointer eventHandler) override;
  ...
  void sendSensorEventIndication(
      const proto::messages::SensorEventIndication& indication,
      SendPromise::Pointer promise) override;
  void sendSensorStartResponse(
