...
struct DataBuffer {
  DataBuffer();
  DataBuffer(Data::value_type* _data, Data::size_type _size,
...
struct DataConstBuffer {
  ...
  DataConstBuffer(const Data::value_type* _data, Data::size_type _size,
                  Data::size_type offset = 0);
  DataConstBuffer(const void* _data, Data::size_type _size,
                  Data::size_type offset = 0);
